...
static void PrintUsage()
{
    ...
    Console.WriteLine("  2  — sum and odd values between A and B");
    Console.WriteLine("  3  — draw rectangle, triangles, and rhombus");
    Console.WriteLine("  4  — delivery routes (N!) with do-while factorial");
    Console.WriteLine("  6  — rectangle of stars (nested loops)");
    Console.WriteLine();
